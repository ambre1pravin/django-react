...
var renderModal = function renderModal(modal_id) {
...
var ModalManager = exports.ModalManager = {
   open: function open(component) {
        if(component !== undefined && component.props.modal_id != undefined){
              modals.push(component);
              if (modals.length > 0) {
                 renderModal(component.props.modal_id);
              }
        }
   },
   close: function close(component) {
       if(component.props.modal_id !== undefined && component.props){
            var elem = document.getElementById(component.props.modal_id);
            if(elem){
            ...
            console.log("modal id is not defined")
       }
   }
};