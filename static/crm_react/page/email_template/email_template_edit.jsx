...
class  EmailTemplateEdit extends React.Component {
    ...
    super(props);
      this.state = {
            template_result:{'template_name':null,'subject':null,'editor_txt':null},
            editor_txt:'xyz',
            module_name:null,
            attachements: [],
      }
    ...
    getTemplateById(){
        this.serverRequest = $.get('/email/template/editdata/'+ this.props.params.Id +'/', function (data) {
          let template_result = {'template_id':data.template.id, 'editor_txt':data.template.description,
          'subject':data.template.subject,'template_name':data.template.name};
          if(data.success==true){
          //console.log("here is att", data.attachment)
             this.setState({template_result : template_result, module_name:data.template.module_type, attachements:data.template.attachment});
          }
        }.bind(this));
    }
    ...
    handleSubmit(){
       let templates = this.state.template_result;
       let template={'template_id':this.props.params.Id, 'subject':templates.subject, 'module':this.state.module_name,
  ...
  render() {
    let template = this.state.template_result;
    return (
        <div>
          <Header />
                                ...
                                <div className="row row__flex">
                                  <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <table className="detail_table">
                                        ...
                                        <tr>
                                            <td>
                                                <label className="control-label">{'Select Module'}</label>
                                            </td>
                                            <td>
                                                <div className="form-group">
                                                ...
                                                <div>
                                                     <span>
                                                         ...
                                                         <p>
                                                             ...
                                                             <span className="push-left-10">Quotation Name/Invoice Number:</span><span>[qname]</span>,
                                                         </p>
                                                         <p>
...
module.exports = EmailTemplateEdit;
