...
class  ProductCategoryDropDown extends React.Component {
    ...
    handle_click_item(id, name){
         ...
         this.props.set_return_data({'id': id, 'name':name}, 'product_category');
    }
    ...
    render() {
    console.log("this.state.product_category", this.state.input_value)
        return (
                    ...
                    <div id="company_drop_box" className="dd-options">
                        ...
                        }
                        {
                            this.props.create_option && this.state.item_list.length == 0 ?
                                <li data-action="create" className="text-primary bold"  onClick={this.handle_create.bind(this, this.state.input_value)}>
...
module.exports = ProductCategoryDropDown;