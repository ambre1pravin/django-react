...
class  SalesPersonDropDown extends React.Component {
	constructor(props) {
        super(props);
        this.state = {
    ...
    handle_click_item(id, name){
         ...
         this.props.set_return_data({'id':id,'name':name},'sales_person');
    }



    render() {
        console.log("this.props.selected_name", this.props.selected_name)
        return (
...
module.exports = SalesPersonDropDown;